...
do_ifwhile:
		...
		codePush("r0");
		invalR5();
		codeCallThumb(RP_pimp_gba_vblank, "pimp_vblank");
		codePop("r0");
	} else if (out->use_pimp && W("modframe")) {
		codePush("r0");
		invalR5();
		codeCallThumb(RP_pimp_gba_frame, "pimp_frame");
		codePop("r0");
	} else if (out->use_pimp && W("modclose")) {
		codePush("r0");
		invalR5();
		codeCallThumb(RP_pimp_gba_close, "pimp_close");
		codePop("r0");
		...
		invalR5();
		codeCallThumb(RP__init, "pimp_init");
		codePop("r0");
	} else if (out->use_pimp && W("modsetpos")) {
		codeAsm("r0", "r1", "mov,");
		codePop("r0");
		invalR5();
		codeCallThumb(RP_pimp_gba_set_pos, "pimp_set_pos");
		codePop("r0");
	} else if (out->use_pimp && W("modgetrow")) {
		codePush("r0");
		invalR5();
		codeCallThumb(RP_pimp_gba_get_row, "pimp_get_row");
	} else if (out->use_pimp && W("modgetorder")) {
		codePush("r0");
		invalR5();
		codeCallThumb(RP_pimp_gba_get_order, "pimp_get_order");
	} else if (W("compare")) {
		codePop("r1");
		invalR5();
